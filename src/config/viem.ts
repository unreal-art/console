import { Chain, defineChain, erc20Abi } from "viem"

/**
 * Chain configuration for viem.
 * 
 * Centralized chain definitions for all supported networks.
 * - Default chain: Torus Mainnet (8192)
 * - Use getChain(chainId) to retrieve a chain by ID
 * - Use getDefaultChain() for the default chain
 */
...
export const CHAIN_DEFAULT = torusMainnet
 ...
 * @returns Chain or throws if not supported
 */
