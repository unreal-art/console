...
<section class="container flex h-full flex-col items-start gap-6 overflow-y-auto px-4 pb-10 pt-10">
	...
	<ul>
		...
		<li>
			<p>
				<strong>Website</strong> refers to ZAuth, accessible from
				<a href="https://zauth.netlify.app" rel="external nofollow noopener" target="_blank"
					>https://zauth.netlify.app</a
				>
			</p>
		</li>
		<li>
	...
	<p>
		...
		<!-- Learn more about cookies on the <a href="/" target="_blank"
			>ZAuth </a
		> article. -->
	</p>
	...
	<ul>
		<li>By email: laciferin@proton.me</li>
	</ul>
</section>
