...
type RouteParams = { proofId: string };
type RouteId = '/proof/verify/[proofId]';
...
type LayoutRouteId = RouteId | "/proof/verify/[proofId]"
type LayoutParams = RouteParams & { proofId?: string }
